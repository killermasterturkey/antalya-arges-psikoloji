...
const TestimonialsPage = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      service: 'Çocuk Terapisi',
      rating: 5,
      text: 'Oğlum hırçın, agresif, mutsuz bir çocuktu ve bu beni çok üzüyordu. Nasıl davranacağımı bilemiyordum. Uzmanımız sayesinde nasıl davranmam gerektiğini ve onu nasıl mutlu edebileceğimi öğrendim. Süreç boyunca her daim yanımızda oldular. Güler yüzlü ve gayet samimi bir ortamdı. Yaklaşık 5-6 ay sürdü. Bu kurumu başkalarına tavsiye ederim. Çünkü olaylara bakış açınız değişiyor ve daha farklı şekilde düşünmeye başlıyorsunuz.',
    },
    {
      id: 12,
      name: 'Veysel T.',
    ...
    },
    {
      ...
      service: 'Oyun Terapisi',
      rating: 5,
      text: 'İnternet üzerinden araştırdık ve kendisiyle ilgili olumlu yorumlara ulaştık. İlkokuldaki çocuğumuzun kaygı sorunu vardı ve destek almaya karar verdik. Çok çekingen bir çocuk olmasına rağmen psikoloğumuza hemen ısındı ve anlaştılar. İletişimi güzel, samimi ve ebeveynlere olan desteği çok memnun bırakıyor insanı. Oyun terapisinden ve süreçten bahsetti. Çocukla ilgilenirken bir yandan da bizi eğitti diyebilirim. Çocuğumuz şimdi daha rahat. Her şey için çok teşekkürler.',
    },
    {
      id: 23,
      name: 'B.Y.',
      ...
      service: 'Çocuk Terapisi',
      rating: 5,
      text: '7 yaşındaki oğlumun alt ıslatma problemi vardı. Bulunduğumuz ildeki terapistleri araştırdık ama içimize sinmedi biz de Antalya\'yı araştırmak istedik ve Nezihi Hoca\'dan destek almaya karar verdik. İyi ki de gitmişiz. Çok samimi ve işini iyi yapan bir uzman kendisi. Çok da uzun sürmeyen bir süreç oldu ve sorunumuzu hallettik. Bundan sonra zorlandığımız herhangi bir konuda hemen başvurmayı düşünüyoruz kendisine.',
    },
    {
      id: 24,
      name: 'E.Ş.',
      ...
      service: 'Oyun Terapisi',
      rating: 5,
      text: '4 yaşındaki kızım için danışmıştık kendisine. Kızımı kreşe bırakmak isteyince aşırı hırçın, öfkeli, söz dinlemeyen bir çocuk oluyordu. Bir arkadaşımızın tavsiyesi ile Nezihi Ünal\'dan randevu aldık. Çok yardımcı oldu. Bizim yaptığımız hataları anlattı. Neden böyle davrandığını, temelinde neler olabileceğini ve nasıl ilerlememiz gerektiğini çok açık anlaşılır bir dille aktardı bize. Oyun terapisine başladık ve çok şükür şu an uyum ve ayrılma konusunda bir problem yaşamıyoruz.',
    },
    {
      id: 25,
      name: 'F.Ş.',
    ...
    },
    {
      ...
      service: 'Oyun Terapisi',
      rating: 5,
      text: 'Bir sene önce doğum yaptım. Doğumdan sonra 4,5 yaşındaki oğlumla sıkıntı yaşamaya başladık. Bana karşı çok agresif olmaya, saldırgan ve hırçın bir tutum sergilemeye başladı. İlk seansta karşımda sempatik ve işini severek yapan bir insan görmek beni çok mutlu etti. Bize oyun terapisinden bahsetti ve başladık. Oğlumun psikoloğumuza karşı tavırlarıydı. Oğlum her seansa isteyerek, seve seve gitti. Sonuçtan çok memnun kaldık. İhtiyacı olan herkese tavsiye ederim.',
    },
    {
      id: 28,
      name: 'S.G.',
    ...
    },
    {
      ...
      service: 'Ergen Danışmanlığı',
      rating: 5,
      text: 'Uzmanımıza oğlumun sınavla ilgili korkuları için başvurduk. Oğlum üniversite sınavına hazırlanıyordu. Gece gündüz ders çalışıyordu. Dışarı çıkmıyordu, arkadaşı yoktu, evde bizimle devamlı kavga ediyordu. Başaramamakla ilgili çok büyük korkuları vardı. Geçirdiği süreç çok iyi geldi hepimize. Oğlum sınava çalışmaya devam ediyor ama Nezihi Hocam sayesinde artık ne istediğinden emin. Ve başaracağına inanıyor.',
    },
    {
      id: 37,
      name: 'T.A.',
    ...
    },
    {
      ...
      service: 'Ergen Danışmanlığı',
      rating: 5,
      text: 'Oğlumun rehber öğretmeni yönlendirdiği için gitmiştik. Öğretmeni sınıfta derse dikkatini veremediğini, odak problemi yaşadığını söylemişti. İlaç tedavisine ek olarak terapiye de başladık. Çok güzel ilerleme kaydettik. Seanslara halen devam ediyoruz ve şu an durumumuzdan gayet memnunum. Aynı şekilde oğlum da memnun. Etrafımda sorun yaşayan anne babalara da tavsiye ediyorum.',
    },
    {
      id: 39,
      name: 'P.A.',
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Sınav kaygım için psikoloğa gitmek istedim. Ne yapsam bu konunun üstesinden gelemedim. Benim için korkunç bir hal almaya başlamıştı. Sınav aklıma gelince bile nefesim daralıyordu, kalp atışlarım hızlanıyordu. Nezihi Ünal\'a gitmeye karar verdim. Güler yüzlülüğü, empatisi ve detaylı açıklamaları ile seanslarımızdan çok verim aldım. EMDR ile ilerledik ve artık kaygılarımı kabulleniyorum, kontrol edebiliyorum. Benzer sorunları yaşayan insanlara tavsiye ederim.',
    },
    {
      id: 40,
      name: 'L.T.',
    ...
    },
    {
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Görev yerimiz dolayısıyla ilçede yaşıyoruz. Oğlum şehir merkezinde güzel bir lise kazandı. Ancak eve geldikçe fark etmeye başladık ki oğlum içine kapanmaya başladı. Meğer sosyal fobisi varmış ve bu fobi onu gündelik hayatında çok etkilemeye başlamış. Bize nasıl yaklaşmamız gerektiği yönünde destek sağlarken oğlumla EMDR ile çalışmaya başladılar. Şimdi kalabalıkta daha rahat ve ders ortamında daha aktif. Her şey için teşekkürler.',
    },
    {
      id: 44,
      name: 'S.L.',
    ...
    },
    {
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Bunalım ve boş vermişlik vardı üzerimde. Gerek EMDR gerek psikoterapi süreçleriyle ilerleyerek sorunlarımı aştım. Çok kıymetli ve değerli bir yol arkadaşlığıydı. Kendisine çok teşekkür ediyorum ve kariyerinde başarılar diliyorum.',
    },
    {
      id: 49,
      name: 'B.',
    ...
    },
    {
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Bende panik atak var, bir de sınav süreci geçiriyorum. Hepsi tetikliyordu beni. Beni dinliyor, yardımcı oluyor. Danışan odaklı. EMDR tekniğini kullandık, çok memnun kaldım. Dinliyor, bana iyi geliyor. Süreci atlatmamda yardımcı oldu. Stresim biraz daha azaldı, kendimi daha iyi hissediyorum.',
    },
    {
      id: 52,
      name: 'Z.',
    ...
    },
    {
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Uzun bir süredir ne olduğunu anlayamadığım ama içinden çıkamadığım bir ruh hali içindeydim. Eskiden yapmaktan hoşlandığım şeyleri bile yapasım gelmiyordu. Ancak Nur Deniz Hanım beni oldukça sıcak karşıladı. Konuştukça sizi yargılamadığını ve gerçekten anlaşıldığınızı hissediyorsunuz. Bana EMDR teknikinden bahsetti. Hissettiğim sıkıntılarla ilgili farkında bile olmadığım nedenleri görmemi sağladı. Süreç devam ettikçe bende ne kadar büyük bir değişim olduğunu fark ettim.',
    },
    {
      id: 56,
      name: 'G.Ç.',
      ...
      service: 'Bireysel Terapi',
      rating: 5,
      text: '23 yaşındayım ve hayatım boyunca farklı takıntılarım oldu. Bu sorunu erteledikçe daha da artarak ilerledi. Devamlı her yeri temiz tutmaya çalışıyordum. Bu bir süre sonra beni çok yıpratmaya başladı. Ne kendime ne işime ne de aileme zaman ayıramaz hale geldim. Nur Deniz Hanım ile terapiye başladık. Hem seanstaki anlayışlı ve anlattıklarınızı saygıyla dinleyen yaklaşımı hem de kullandığı teknikler ile takıntılarım azalmaya başladı.',
    },
    {
      id: 57,
      name: 'F.P.',
    ...
    },
    {
      ...
      service: 'Bireysel Terapi',
      rating: 5,
      text: '2 sene önce boğazıma bir cismin kaçması sonucu aşırı bir ölüm korkusu duymaya başladım. Devamlı boğazıma bir şeyler kaçacağından veya öleceğimden korkuyordum. Bir süre sonra artık dışarıya çıkamaz hale geldim. Uzun arayışlarım sonucu Deniz Hanımla terapilere başladık. Zamanla bendeki değişimi etrafımdaki herkes fark etmeye başladı. Ama en önemlisi ben o korkuları artık içimde hissetmiyorum. Deniz Hanımı gönül rahatlığıyla öneririm.',
    },
    {
      id: 63,
      name: 'N.T.',
    ...
    },
    {
      ...
      service: 'EMDR Terapisi',
      rating: 5,
      text: 'Yaşadığım sorunlar kendini ifade etme konusunda yetersizlik, bir şeyleri başaramama korkusu ve güvensizlik duygusuydu. EMDR terapi yöntemi sayesinde sağladığım olumlu geri bildirimler açıkçası beni çok mutlu ediyor. Hala devam ediyorum ve daha huzurlu ve daha mutlu hissediyorum. Nur Deniz Hanımla yaptığımız seanslar hayata karşı daha güvenli durmamı sağladı. Kesinlikle herkese tavsiye ediyorum.',
    },
    {
      id: 66,
      name: 'R.A.',
    ...
    // ÇİFT TERAPİSİ
    {
      ...
      rating: 5,
      text: 'İnternetten araştırarak bulmuştum. Deniz Hanım\'la çift terapisine başladık, çok memnun kaldık. Herkese tavsiye ederim. Çok güzel dinliyor ve güzel yorumlar katıyor. Birbirimizi anlamamızı sağlıyor. Görüşmeler sonucu kendimi daha iyi hissettim.',
    },
    {
      id: 68,
      name: 'F.Ü.',
      ...
      service: 'Çift Terapisi',
      rating: 5,
      text: 'Deniz Hanım\'dan evliliğimiz hakkında destek aldık. Eşim ilk etapta terapiye gitme konusunda isteksizdi ama Deniz Hanım\'ın yaklaşımı onu rahatlatınca istekle gitmeye başladı. Nur Deniz Hanım\'la birlikte sorunlarımızı etkili bir biçimde çözdük. Çok güler yüzlü, samimi ve işinde çok başarılı biri. İnsana güven veriyor ve sıkıntınızı rahatça paylaşabiliyorsunuz. Kesinlikle tavsiye ederim.',
    },
    {
      id: 69,
      name: 'F.S.',
    ...
    },
    {
      ...
      service: 'Çift Terapisi',
      rating: 5,
      text: 'Nur Deniz hocaya internetten araştırmalarımız sonucu ulaştık. Terapiye gelinceye kadar önyargılarımız vardı çünkü Deniz hocadan önce farklı terapistlerden terapi alıp hayal kırıklığı ile sonlandırmıştık. Kendisine çift terapisi için başvurduğumuzda evliliğimizin temelini adeta yeniden oluşturduğumuzu fark ettik. Eşimle birbirimizi daha iyi anlamayı dinlemeyi ve keşfetmemizi sağladı. Kendisine ne kadar teşekkür etsek azdır.',
    },
    {
      id: 73,
      name: 'E.M.',
    ...
    // CİNSEL TERAPİ - Mevcut yorumlar + Yeni eklenen 5 yorum
    {
      ...
      rating: 5,
      text: 'Son bir senedir ara ara devam eden erken boşalma problemlerim vardı. Bu sorundan dolayı pek çok partner değiştirmek zorunda kaldım. İlişkilerimde bu sorun yüzünden tartışmalar hatta ayrılıklar oluyordu. Gittiğim ürolog herhangi bir sorun olmadığını ve bir cinsel terapistle görüşmemin faydalı olacağını söyledi. Seansa ilk gittiğimde oldukça gergindim. Ancak Nur Hanımın güven veren yaklaşımı ve mahremiyete verdiği önem beni rahatlattı. Seanslara devam ediyoruz ve şimdiden ilerlediğimizi fark edebiliyorum.',
    },
    {
      id: 76,
      name: 'S.B.',
