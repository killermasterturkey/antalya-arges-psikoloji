      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-olive/10 px-6 py-3 rounded-full">
                <i className="ri-user-star-line text-olive text-xl"></i>
                <span className="font-sans text-sm font-medium text-darkgray">Ergen Danışmanlığı</span>
              </div>
              <h1 className="font-serif text-5xl lg:text-7xl font-bold text-darkgray">
                Ergen Danışmanlığı Yorumları
              </h1>
            </motion.div>
        ...
        <section className="py-20 px-6 lg:px-12 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-4xl font-bold text-darkgray mb-6">Ergenler İçin Randevu Alın</h2>
...
export default TestimonialsErgenPage;
