      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-white border border-darkgray/20 px-4 py-2 rounded-full">
                  ...
                  <span className="font-sans text-sm text-darkgray">18+ Yaş</span>
                </div>
              ...
              >
                <div className="w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                  <img
                    ...
                    alt="Yetişkinler İçin MOXO Dikkat Testi"
        ...
        <section className="py-20 px-6 lg:px-12 bg-cream">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-4xl font-bold text-darkgray mb-6">Dikkat Profilinizi Keşfedin</h2>
            <p className="font-sans text-lg text-darkgray/70 mb-8">Profesyonel MOXO testi ile dikkat ve odaklanma kapasitenizi analiz edin.</p>
...
export default YetiskinlerIcinMoxoPage;
