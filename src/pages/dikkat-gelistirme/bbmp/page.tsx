...
const BbmpPage = () => {
  const features = [
    { icon: 'ri-brain-line', title: 'Beyin Gelişimi', description: 'Nörolojik gelişimi destekleyen egzersizler.' },
    { icon: 'ri-focus-3-line', title: 'Dikkat Artışı', description: 'Odaklanma ve dikkat süresi gelişimi.' },
    { icon: 'ri-book-2-line', title: 'Akademik Başarı', description: 'Okul performansını artırma.' },
    { icon: 'ri-run-line', title: 'Motor Beceriler', description: 'İnce ve kaba motor gelişimi.' },
  ];
      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-white border border-darkgray/20 px-4 py-2 rounded-full">
                  <i className="ri-brain-line text-olive"></i>
                  <span className="font-sans text-sm text-darkgray">Beyin Gelişim</span>
                </div>
              ...
              >
                <div className="w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                  <img
                    src="https://images.unsplash.com/photo-1606092195730-5d7b9af1efc5?w=800&h=600&fit=crop"
                    alt="BBMP - Beyin ve Beden Motor Programı"
        ...
        <section className="py-20 px-6 lg:px-12 bg-cream">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-4xl font-bold text-darkgray mb-6">BBMP ile Gelişim</h2>
            <p className="font-sans text-lg text-darkgray/70 mb-8">Çocuğunuzun beyin gelişimini destekleyen özel program için bilgi alın.</p>
