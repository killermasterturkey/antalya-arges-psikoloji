...
const AntalyaCinselTerapiPage = () => {
  ...
  const topics = [
    ...
    { icon: 'ri-mental-health-line', title: 'İstemsiz Kasılmalar', description: 'Cinsel birliktelikte yaşanan istemsiz kasılmalar.' },
  ];
