...
const AntalyaEmdrPage = () => {
  const benefits = [
    { icon: 'ri-mental-health-line', title: 'Travma Tedavisi', description: 'Travmatik anılar ve TSSB tedavisi.' },
    { icon: 'ri-heart-pulse-line', title: 'Kaygı Bozuklukları', description: 'Panik atak ve genel kaygı.' },
    { icon: 'ri-emotion-sad-line', title: 'Depresyon', description: 'Depresyon belirtilerinin azaltılması.' },
    { icon: 'ri-shield-user-line', title: 'Fobiler', description: 'Özel fobiler ve korkular.' },
  ];
      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center space-x-2 bg-white border border-darkgray/20 px-4 py-2 rounded-full">
                  <i className="ri-eye-line text-olive"></i>
                  <span className="font-sans text-sm text-darkgray">EMDR Terapi</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  ...
                  <h3 className="font-sans text-lg font-bold text-darkgray">{benefit.title}</h3>
                  <p className="font-sans text-sm text-darkgray/70">{benefit.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-6 lg:px-12 bg-cream">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-4xl font-bold text-darkgray mb-6">EMDR Terapisi ile İyileşme</h2>
            <p className="font-sans text-lg text-darkgray/70 mb-8">Sertifikalı EMDR terapistimiz ile travmalarınızdan kurtulun.</p>
...
export default AntalyaEmdrPage;
